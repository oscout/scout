...
const expectedRouteInventory = [
  ...
  "GET /v1/mesh/node-state",
  "GET /v1/mesh/nodes",
  "GET /v1/mesh/snapshot",
  "GET /v1/message-reactions",
  "GET /v1/messages",
  ...
  "POST /v1/mesh/sessions/wake",
  "POST /v1/message-reactions",
  "POST /v1/message-reactions/remove",
  "POST /v1/messages",
