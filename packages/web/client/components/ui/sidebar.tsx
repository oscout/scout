...
function SidebarMenuButton({
  ...
  // Labels belong to the icon rail only. Keep the popup mounted and gate its
  // controlled state so Base UI cannot retain an expanded-rail hover and
  // reopen several stale labels when the rail collapses.
  React.useEffect(() => {
    setLabelOpen(false);
  }, [state]);
  ...
  return (
    <Tooltip
      open={state === "collapsed" && labelOpen}
      onOpenChange={(open) => setLabelOpen(state === "collapsed" && open)}
    >
      {comp}
